...
#define MyAppName "SkyRoof X2 PlugIn"
...
AppId={{69AC7DE5-7BCA-492A-BEC7-4FE8E0618C46}
AppName={#MyAppName}
...
OutputBaseFilename=SkyRoof_X2_Installer
...
[Files]
Source: "domelist SkyRoof.txt";                         DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion
Source: "domelist SkyRoof.txt";                         DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion; DestName: "domelist64 SkyRoof.txt"
; 32 bits
Source: "libSkyRoof\Win32\Release\libSkyRoof.dll";      DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
Source: "SkyRoof.ui";                                   DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
Source: "SkyRoof.png";                                  DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
; 32 bits
Source: "libSkyRoof\x64\Release\libSkyRoof.dll";        DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
Source: "SkyRoof.ui";                                   DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
Source: "SkyRoof.png";                                  DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
