...
cp "./SkyRoof.ui" "$TheSkyX_Path/Resources/Common/PlugIns/DomePlugIns/"
cp "./SkyRoof.png" "$TheSkyX_Path/Resources/Common/PlugIns/DomePlugIns/"
...
if [ ! -z "$app_owner" ]; then
	...
	chown $app_owner "$TheSkyX_Path/Resources/Common/PlugIns/DomePlugIns/SkyRoof.ui"
	chown $app_owner "$TheSkyX_Path/Resources/Common/PlugIns/DomePlugIns/SkyRoof.png"
fi
